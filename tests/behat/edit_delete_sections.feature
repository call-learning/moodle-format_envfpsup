@format @format_envfpsup
Feature: Sections can be edited and deleted in sections format
  ...
  @javascript
  Scenario: Inline edit section name in envfpsup format
  ...
  Scenario: Deleting the last section in envfpsup format
  ...
  Scenario: Deleting the middle section in envfpsup format
  ...
  @javascript
  Scenario: Adding sections in envfpsup format
